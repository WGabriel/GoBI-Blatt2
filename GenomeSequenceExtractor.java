...
public class GenomeSequenceExtractor {
    ...
    // Constructor
    public GenomeSequenceExtractor(File fasta, File idx, File gtf) {
        super();
        this.fasta = fasta;
        this.idx = idx;
        this.gtf = gtf;
        this.genes = GenomeSequenceExtractor.parseGene(gtf);
    }
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (!line.startsWith("#")) {
                    ...
                    if (feature.equals("exon")) {
                        ...
                        Exon e = new Exon(seqname, Integer.parseInt(start) - 1, Integer.parseInt(end), strand, exon_id,
...
//				+ ". Result string length: " + result.length() + "/" + (seqEnd - seqStart));
    ...
    public int getGenomicPosition(String transcriptId, String geneId, int positionInTranscript) {
        ...
        if (result <= 0) {
            System.err.println("|getGenomicPosition| positionInTranscript " + positionInTranscript
                    + " not found. geneId: " + geneId + " transcriptId: " + transcriptId);
        }
        return result;
    }
